...
```{r}
library(ggplot2)
ggplot(loan_default, aes(x = tot_balance)) + geom_boxplot() + labs(title = "Box plot of Total Balance", x = 'Total balance', y = 'Frequency')
```
