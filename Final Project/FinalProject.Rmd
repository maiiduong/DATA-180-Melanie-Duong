...
Load the dataset in.
```{r}
loan_default <- read.csv("C:/Users/rodge/OneDrive/Desktop/DATA 180 -Intoduction to Data Science/DATA-180-Introduction-to-Data-Science--Section-2/data/loan_default_data_set.csv")
loan_default
```
...
# You would fit a supervised learning model because you have very clear dependent and independent variables.(-2)
```
