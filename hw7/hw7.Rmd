...
library(tidyverse)
library(tm)
news<-read.csv("C:/Users/maidn/OneDrive/Desktop/DATA 180 Melanie Duong/DATA-180-Melanie-Duong/DATA-180-Melanie-Duong/hw7/news.csv",header=T)
news
```
...
```{r}
posWords <- scan("C:/Users/maidn/OneDrive/Desktop/DATA 180 Melanie Duong/DATA-180-Melanie-Duong/DATA-180-Melanie-Duong/hw7/positive-words.txt", character(0), sep = "\n")  # 2006 items
negWords <- scan("C:/Users/maidn/OneDrive/Desktop/DATA 180 Melanie Duong/DATA-180-Melanie-Duong/DATA-180-Melanie-Duong/hw7/negative-words.txt", character(0), sep = "\n")  # 4783 items
head(posWords,15)
head(negWords,15)
```
...
```{r}
#head(wordFrequency, 20)
term_stats(charVector, ngrams = 1, filter = text_filter(drop_puct = TRUE, drop_symbol = TRUE, drop = stopwords_en))
...
```{r}
term_stats(charVector, ngrams = 2, filter = text_filter(drop_puct = TRUE, drop_symbol = TRUE, drop = stopwords_en))
```
