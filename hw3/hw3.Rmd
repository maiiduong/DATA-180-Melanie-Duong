...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city)) + geom_point(col = "blue", size = 2) + xlim(0,6) + ylim(10,50) + labs(y = "MPG per city", x = "Size of engine", title = "Scatter plot of Engine Size vs MPG per city", subtitle = "Using ggplot2 in R")
...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city, color =  Type)) + geom_point(size = 2) + xlim(0,6) + ylim(10,50) + labs(y = "MPG per city", x = "Size of engine", title = "Scatter plot of Engine Size vs MPG per city", subtitle = "Using ggplot2 in R")
```
...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city, color = Type)) + geom_point(size = 2) + xlim(0,6) + ylim(10,50) + labs(x = "MPG in city", y = "Size of engine", title = "Scatter plot of Engine Size vs MPG per city", subtitle = "Using ggplot2 in R") + geom_smooth(linetype = "dashed", color = "red")
```
...
```{r}
ggplot(Cars93, aes(x = AirBags, fill = AirBags)) + geom_bar() + labs(title = "Count of Cars by Airbags", subtitle = "Using ggplot2 in R", x = "Airbags", y = "Count")
```
...
```{r}
ggplot(Cars93, aes(x = Origin, fill = AirBags)) + geom_bar(position = "dodge") + labs(title = "Count of Cars by Airbags for Different Origins", subtitle = "Using ggplot2 in R", x = "Origin", y = "Count")
```
...
```{r}
data_au <- map_data("world", region = "Australia")
ggplot() + geom_polygon(data = data_au, aes(x=long, y=lat, group=group), fill = "lightblue", color = "black") + labs(title = "Map of Australia")
```
...
```{r}
data_au <- map_data("world", region = "Australia")
ggplot() + geom_sf(data = au_states, aes(fill = NAME)) + labs(title = "Map of Australia") + theme_classic()
```
## Task 3
...
```{r}
data_au <- map_data("world", region = "Australia")
ggplot() + geom_sf(data = au_states, aes(fill = NAME)) + labs(title = "Map of Australia") + theme_classic() + geom_point(data = au_capitals, aes(x = lon, y = lat, col = "red", size = 2))
```
...
```{r}
data_au <- map_data("world", region = "Australia")
ggplot() + geom_sf(data = au_states, aes(fill = NAME)) + labs(title = "Map of Australia") + theme_classic() + coord_sf(crs = st_crs(3112))
```
...
```{r}
mapview(au_states, zcol = "NAME") + mapview(capitals_geo, col.regions = "red", legend = F)
```
