...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city)) + geom_point(col = "blue", size = 2) + xlim(0,6) + ylim(10,50) + labs(y = "MPG per city", x = "Size of engine", title = "Scatter plot of Engine Size vs MPG per city")
...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city, color =  Type)) + geom_point(size = 2) + xlim(0,6) + ylim(10,50) + labs(y = "MPG per city", x = "Size of engine", title = "Scatter plot of Engine Size vs MPG per city")
```
