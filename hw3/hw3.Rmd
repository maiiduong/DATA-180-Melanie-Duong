...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city)) + geom_point(col = "blue", size = 2) + xlim(0,6) + ylim(10,50) + labs(y = "MPG in city", x = "Size of engine")
...
```{r}
ggplot(Cars93, aes(x=EngineSize, y=MPG.city, color =  Type)) + geom_point(size = 2) + xlim(0,6) + ylim(10,50) + labs(y = "MPG in city", x = "Size of engine")
```
